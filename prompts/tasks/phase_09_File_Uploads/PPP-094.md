...
1. **Branch:** `feature/PPP-094-attachment-tests` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `test(attachments): add file size validation and auth tests` (see GIT_WORKFLOW.md §5)
