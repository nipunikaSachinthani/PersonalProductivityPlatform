...
1. **Branch:** `feature/PPP-040-projects-schema` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(projects): create Projects and ProjectMembers tables` (see GIT_WORKFLOW.md §5)
