...
1. **Branch:** `feature/PPP-043-update-archive-project` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(projects): add update and archive project endpoints` (see GIT_WORKFLOW.md §5)
