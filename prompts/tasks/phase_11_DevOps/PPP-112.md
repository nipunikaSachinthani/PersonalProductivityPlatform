...
1. **Branch:** `feature/PPP-112-cd-deploy` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `ci(devops): add test execution and CD deployment workflow` (see GIT_WORKFLOW.md §5)
