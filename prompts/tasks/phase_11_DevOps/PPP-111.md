...
1. **Branch:** `feature/PPP-111-ci-lint` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `ci(devops): add lint and format checks to CI` (see GIT_WORKFLOW.md §5)
