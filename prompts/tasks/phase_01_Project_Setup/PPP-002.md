...
1. **Branch:** `feature/PPP-002-scaffold-backend` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(setup): scaffold .NET clean architecture solution` (see GIT_WORKFLOW.md §5)
