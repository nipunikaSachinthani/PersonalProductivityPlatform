...
1. **Branch:** `feature/PPP-007-health-check-e2e` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(setup): add health check endpoint and landing page` (see GIT_WORKFLOW.md §5)
