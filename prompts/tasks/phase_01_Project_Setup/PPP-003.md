...
1. **Branch:** `feature/PPP-003-scaffold-frontend` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(setup): scaffold react+vite+tailwind+shadcn frontend` (see GIT_WORKFLOW.md §5)
