...
1. **Branch:** `feature/PPP-076-notification-tests` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `test(notifications): add event handler and background job tests` (see GIT_WORKFLOW.md §5)
