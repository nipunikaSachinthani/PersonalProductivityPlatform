...
1. **Branch:** `feature/PPP-050-notes-schema` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(notes): create Notes, Categories, NoteCategories tables` (see GIT_WORKFLOW.md §5)
