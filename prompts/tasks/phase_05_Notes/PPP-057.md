...
1. **Branch:** `feature/PPP-057-notes-tests` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `test(notes): add search and sanitization tests` (see GIT_WORKFLOW.md §5)
