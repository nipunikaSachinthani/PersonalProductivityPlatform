...
1. **Branch:** `feature/PPP-064-drag-reschedule` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(calendar): add drag-to-reschedule for task due dates` (see GIT_WORKFLOW.md §5)
