...
1. **Branch:** `feature/PPP-103-test-docs-coverage` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `docs(testing): add test run instructions and coverage config` (see GIT_WORKFLOW.md §5)
