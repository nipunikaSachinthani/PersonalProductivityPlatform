...
1. **Branch:** `feature/PPP-014-password-reset` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(auth): implement forgot/reset password flow` (see GIT_WORKFLOW.md §5)
