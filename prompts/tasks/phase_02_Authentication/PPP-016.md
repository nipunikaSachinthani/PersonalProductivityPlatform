...
1. **Branch:** `feature/PPP-016-user-profile` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(auth): add GET /users/me endpoint` (see GIT_WORKFLOW.md §5)
