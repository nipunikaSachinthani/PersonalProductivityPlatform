...
1. **Branch:** `feature/PPP-018-register-page` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(auth): build registration page` (see GIT_WORKFLOW.md §5)
