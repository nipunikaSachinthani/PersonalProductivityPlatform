...
1. **Branch:** `feature/PPP-010-identity-schema` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(auth): create identity database schema` (see GIT_WORKFLOW.md §5)
