...
1. **Branch:** `feature/PPP-030-tasks-schema` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(tasks): create Tasks table schema and migration` (see GIT_WORKFLOW.md §5)
