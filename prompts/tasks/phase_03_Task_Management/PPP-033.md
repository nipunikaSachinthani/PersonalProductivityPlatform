...
1. **Branch:** `feature/PPP-033-get-update-task` off `main` (see GIT_WORKFLOW.md §3)
2. **Commits:** Conventional format — `feat(tasks): add get-by-id and update task endpoints` (see GIT_WORKFLOW.md §5)
